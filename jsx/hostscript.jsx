...
function addNullCenter() {
  try {
    ...
    // Trim the null's timeline bar to the selection's span (as long as the layers).
    if (minIn !== null && maxOut !== null && maxOut > minIn) {
      try { nl.inPoint = minIn; } catch (ei) {}
      try { nl.outPoint = maxOut; } catch (eo) {}
    }

    // Put the null directly ABOVE the topmost selected layer, then parent them.
